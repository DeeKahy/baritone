...
public class RenderCommand extends Command {
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        ctx.minecraft().level.setSectionRangeDirty(
                SectionPos.blockToSectionCoord(origin.x - renderDistance),
                SectionPos.blockToSectionCoord(ctx.world().getMinY()),
                SectionPos.blockToSectionCoord(origin.z - renderDistance),
                SectionPos.blockToSectionCoord(origin.x + renderDistance),
                SectionPos.blockToSectionCoord(ctx.world().getMaxY()),
                SectionPos.blockToSectionCoord(origin.z + renderDistance)
        );
        logDirect("Done");
    }
